...
namespace Practica_4._2._3
{
    public partial class Form1 : Form
    {
        ...
        {
            int intResultado = unaCircunferencia.CompareTo(unTrianguloEquilatero);
            switch (intResultado)
            {
                default:
                    break;
                case -1: MessageBox.Show("El area de circunferencia es menor que el area del triangulo equilatero");
                    break;
                case 0: MessageBox.Show("El area de la circunferencia es igual al area del triangulo equilatero");
                    break;
                case 1: MessageBox.Show("El area de la circunferencia es mayor que el area del trinagulo equilatero");
                    break;
            }
        }
